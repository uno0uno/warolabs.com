<template>
  <header class="fixed top-0 left-0 right-0 h-[60px] sm:h-[72px] flex items-center justify-between px-4 sm:px-5 md:px-10 z-50 glass border-b border-glass-border transition-all duration-300">
