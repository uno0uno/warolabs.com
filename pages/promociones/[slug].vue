  ...
  >
    ...
    >
      <div class="md:col-span-6 lg:col-span-7 flex flex-col gap-6 md:gap-8">
        ...
        <div class="flex flex-col gap-4" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
          <div >
            <meta
      ...
      <TheProductImage v-bind:imgHash="promo.image"> </TheProductImage>
    </div>
    ...
    <Head>
      ...
      <Meta
        property="og:image"
        v-bind="{
          content: `https://warocolombia.infura-ipfs.io/ipfs/${promo.image}`,
        }"
      />
