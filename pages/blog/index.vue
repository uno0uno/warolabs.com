...
<template>
  ...
  <CommonTheBreadcrumb></CommonTheBreadcrumb>
    <div class="grid divide-x divide-dashed divide-y divide-x-4 divide-y-4 divide-slate-200 justify-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-2 py-4">
