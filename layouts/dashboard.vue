  ...
  <div class="flex h-screen bg-background text-foreground">
    ...
    <aside class="w-72 bg-card p-4 flex flex-col justify-between border-r border-border">
      ...
      <div class="flex flex-col gap-2 justify-between h-full py-2">
        <div class="flex flex-col gap-4">
          <div class="flex items-center gap-2">
            <div class="w-8 h-8 rounded-md bg-foreground flex items-center justify-center font-bold text-background">W
            </div>
            <div>
          ...
          <div>
            <nav class="grid grid-cols-2 gap-2">
              ...
              <UiButton variant="ghost" size="sm"
                class="flex flex-col h-auto p-3 border-2 border-border hover:bg-accent">
                <div class="flex flex-col items-center gap-1">
          ...
          <!-- Favorites -->
          <div>
            <UiButton variant="ghost" class="w-full justify-start p-0 h-auto text-xs text-muted-foreground mb-2"
            ...
            <div class="overflow-hidden transition-all duration-300"
              :style="{ maxHeight: favoritesOpen ? '200px' : '0px' }">
          ...
          <div>
            ...
            <div class="overflow-hidden transition-all duration-300"
              :style="{ maxHeight: marketingOpen ? '300px' : '0px' }">
              <nav class="flex flex-col gap-2">
                <UiButton variant="ghost" class="justify-start px-3 py-2 h-auto border-2 border-border hover:bg-accent"
                  @click="selectedMarketingItem = 'Product'">
      ...
      <div class="flex flex-col gap-6">
        ...
        <!-- Footer user -->
        <div>
          <UiButton v-if="user" variant="ghost" class="w-full h-auto p-2 hover:bg-accent justify-start"
            ...
            <div class="flex items-center gap-3 w-full">
              ...
              <svg class="w-4 h-4 text-muted-foreground transition-transform" :class="{ 'rotate-180': userMenuOpen }"
          ...
          <div class="overflow-hidden transition-all duration-300"
            :style="{ maxHeight: userMenuOpen && user ? '400px' : '0px' }">
...
const navigateToEmails = () => {
  ...
  navigateTo('/dashboard/campaigns/settings')
}
