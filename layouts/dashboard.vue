          ...
          <div>
            ...
            <div class="overflow-hidden transition-all duration-300" :style="{ maxHeight: marketingOpen ? '300px' : '0px' }">
              <nav class="flex flex-col gap-2">
                ...
                <UiButton variant="ghost" class="justify-start px-3 py-2 h-auto border-2 border-border hover:bg-accent" @click="navigateToEmails">
...
const navigateToEmails = () => {
  ...
  navigateTo('/dashboard/email-campaigns')
}
